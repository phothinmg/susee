...
use susee_types::DependenciesTree;
...
mod tests {
    ...
    fn run_hooks_preserves_tree_fields() {
        ...
        assert_eq!(result.project_type, susee_types::ProjectType::TS);
