...
#[cfg(test)]
mod tests {
    use crate::core::deps::graph;
    use crate::core::deps::graph::PathBuf;
    use crate::core::deps::graph::collect::normalize_path;
    use crate::core::deps::graph::collect_dependencies;
    use crate::core::deps::graph::get_package_info;
    use std::fs;
    use std::path::Path;
