...
use crate::core::susee_hooks::{anonymous_handler, clean, export_default_handler, remove_handler};
...
///
/// ```no_run
/// use susee::core::susee_bundler::bundler;
///
...
pub fn bundler<P: AsRef<Path>>(
    ...
    let mut dep_files: Vec<super::susee_types::DepsFile> = tree.dep_files;
