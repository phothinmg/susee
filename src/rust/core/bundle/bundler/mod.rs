...
use crate::core::bundle::tree::susee_tree;

use crate::core::bundle::types::{ModuleType, ProjectType};
use crate::core::bundle::utils::{is_non_local_import, merge_content, merge_imports_statement};
...
pub fn bundler<P: AsRef<Path>>(
    entry: &str,
    root: P,
    opts: crate::core::bundle::tree::CheckOptions,
