...
use crate::core::bundle::tree::checks::helpers::{
    CheckKind, CheckReport, check_anonymous, check_default_exports, check_duplicates,
    check_undefined_usage,
};
use crate::core::bundle::tree::checks::check_installed;
use crate::core::bundle::tree::index::get_deps;
use crate::core::bundle::tree::package_info::get_package_info;
...
fn extract_location(item: &crate::core::bundle::tree::checks::helpers::CheckItem) -> (String, u32, u32) {
